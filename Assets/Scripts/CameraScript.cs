...
public class CameraScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Bedingungen player presses back + bewegung in richtung zur�ck, also speed gr��er als 1 und richtung zwischen 120 und 181 grad
    ...
    /// 
    /// Problem: wenn grappled wird, dann wird st�ndig gewechselt
    /// check for grounded?
    /// </summary>
